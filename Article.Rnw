...
<<echo=FALSE>>=
OldAspen_16day <- read.csv("OldAspen_16day.csv",header=TRUE)[,2]
OldAspen_daily <- read.csv("OldAspen_daily.csv",header=TRUE)[,2]
OldAspen_NDVI <- read.csv("OldAspen_NDVI.csv",header=TRUE)[,2]

OldJackPine_16day <- read.csv("OldJackPine_16day.csv",header=TRUE)[,2]
OldJackPine_daily <- read.csv("OldJackPine_daily.csv",header=TRUE)[,2]
OldJackPine_NDVI <- read.csv("OldJackPine_NDVI.csv",header=TRUE)[,2]

Southern_16day <- read.csv("Southern_16day.csv",header=TRUE)[,2]
Southern_daily <- read.csv("Southern_daily.csv",header=TRUE)[,2]
Southern_NDVI <- read.csv("Southern_NDVI.csv",header=TRUE)[,2]

YoungJackPine_16day <- read.csv("YoungJackPine_16day.csv",header=TRUE)[,2]
YoungJackPine_daily <- read.csv("YoungJackPine_daily.csv",header=TRUE)[,2]
YoungJackPine_NDVI <- read.csv("YoungJackPine_NDVI.csv",header=TRUE)[,2]

QC2000_16day <- read.csv("QC2000_16day.csv",header = TRUE)[,2]
QC2000_daily <- read.csv("QC2000_daily.csv",header = TRUE)[,2]
QC2000_NDVI <- read.csv("NDVI_QC2000.csv")[,2]
@
...
<<echo=FALSE,fig.width=12, fig.height=4,fig.cap='Quebec City harvested black spruce/jack pine CO2 flux data from 2003 to 2010.',fig.align='center',eval=FALSE>>=
plot(QC2000_daily,ylim = c(-1,1.5), pch=19, col=2,cex=0.2,axes = FALSE,xlab="Time",ylab="FlxTwr CO2 Data (umol/m2/s)")
lines(QC2000_daily,col="grey")

abline(v=cumsum(c(365,366,365,365,365,365,366)),lty="dashed")

t_x <- rep(177,8) + rep((0:7)*365)
text(t_x,1,labels = c("2003","2004","2005","2006","2007","2008","2009","2010"),cex=0.7)

lab <- c("Jan","June") 
axis(side=1, at=rep(c(1,177),8)+rep((0:7)*365,rep(2,8)), labels= rep(lab,8), las=1)
axis(side=2, at=seq(-1,1.5,by=0.5), lab=seq(-1,1.5,by=0.5), las=2)
title(main="QC-2000 Harvested Black Spruce/Jack Pine (HBS00) \n 2003 - 2010  Lat:49.27   Long:-74.04")

d16_x <- rep(seq(1,366,by=16),8) + rep((0:7)*365,rep(23,8))  
points(d16_x,QC2000_16day,col="Blue",pch=20,cex=0.7)
lines(d16_x,QC2000_16day,col="Blue",lwd=0.7)

legend("bottomleft",c("Daily avg","16-day avg"),pch=c(20,20),col=c(2,"blue"))
@
...
<<echo=FALSE,fig.width=12, fig.height=4,fig.cap='Saskatchewan old aspen CO2 flux data from 2003 to 2008.',fig.align='center',eval=FALSE>>=
plot(OldAspen_daily,ylim = c(-25,10), pch=19, col=2,cex=0.2,axes = FALSE,xlab="Time",ylab="FlxTwr CO2 Data (umol/m2/s)")
lines(OldAspen_daily,col="grey")

abline(v=cumsum(c(365,366,365,365,365)),lty="dashed")

t_x <- rep(177,6) + rep((0:5)*365)
text(t_x,5,labels = c("2003","2004","2005","2006","2007","2008"),cex=0.7)

lab <- c("Jan","June")
axis(side=1, at=rep(c(1,177),6)+rep((0:5)*365,rep(2,6)), labels= rep(lab,6), las=1)
axis(side=2, at=seq(-25,5,by=5), lab=seq(-25,5,by=5), las=2)
title(main="SK-Old Aspen 2003 - 2008 \n Lat:53.63   Long:-106.20")

d16_x <- rep(seq(1,366,by=16),6) + rep((0:5)*365,rep(23,6))  
points(d16_x,OldAspen_16day,col="Blue",pch=20,cex=0.7)
lines(d16_x,OldAspen_16day,col="Blue",lwd=0.7)
...
<< echo=FALSE, fig.width=12, fig.height=4,fig.cap='Saskatchewan old jack pine CO2 flux data from 2003 to 2008.',fig.align='center',eval=FALSE>>=
plot(OldJackPine_daily,ylim = c(-10,10), pch=19, col=2,cex=0.2,axes = FALSE,xlab="Time",ylab="FlxTwr CO2 Data (umol/m2/s)")
lines(OldJackPine_daily,col="grey")
...
lab <- c("Jan","June")
axis(side=1, at=rep(c(1,177),6)+rep((0:5)*365,rep(2,6)), labels= rep(lab,6), las=1)
axis(side=2, at=seq(-10,5,by=5), lab=seq(-10,5,by=5), las=2)
title(main="SK-Old Jack Pine 2003 - 2008 \n Lat:53.92   Long:-104.69")

d16_x <- rep(seq(1,366,by=16),6) + rep((0:5)*365,rep(23,6))  
points(d16_x,OldJackPine_16day,col="Blue",pch=20,cex=0.7)
lines(d16_x,OldJackPine_16day,col="Blue",lwd=0.7)
...
<< echo=FALSE, fig.width=12, fig.height=4, fig.cap='Saskatchewan southern old black spruce CO2 flux data from 2003 to 2008.',fig.align='center',eval=FALSE>>=
plot(Southern_daily,ylim = c(-10,10), pch=19, col=2,cex=0.2,axes = FALSE,xlab="Time",ylab="FlxTwr CO2 Data (umol/m2/s)")
lines(Southern_daily,col="grey")
...
axis(side=1, at=rep(c(1,177),6)+rep((0:5)*365,rep(2,6)), labels= rep(lab,6), las=1)
axis(side=2, at=seq(-10,5,by=5), lab=seq(-10,5,by=5), las=2)
title(main="SK-Southern Old Black Spruce 2003 - 2008 \n Lat:53.99   Long:-105.12")

d16_x <- rep(seq(1,366,by=16),6) + rep((0:5)*365,rep(23,6))  
points(d16_x,Southern_16day,col="Blue",pch=20,cex=0.7)
lines(d16_x,Southern_16day,col="Blue",lwd=0.7)
...
<< echo=FALSE, fig.width=6, fig.height=3,fig.cap='Saskatchewan young jack pine CO2 flux data from 2004 to 2006.',fig.align='center',eval=FALSE>>=
plot(YoungJackPine_daily,ylim = c(-10,10), pch=19, col=2,cex=0.2,axes = FALSE,xlab="Time",ylab="FlxTwr CO2 Data (umol/m2/s)")
lines(YoungJackPine_daily,col="grey")

abline(v=cumsum(c(366,365)),lty="dashed")

t_x <- rep(177,6) + rep((0:5)*365)
text(t_x,5,labels = c("2004","2005","2006"),cex=0.7)

lab <- c("Jan","June") 
axis(side=1, at=rep(c(1,177),3)+rep((0:2)*365,rep(2,3)), labels= rep(lab,3), las=1)
axis(side=2, at=seq(-10,5,by=5), lab=seq(-10,5,by=5), las=2)
title(main="SK-1975 (Young) Jack Pine 2004 - 2006 \n Lat:53.88   Long:-104.65")

d16_x <- rep(seq(1,366,by=16),3) + rep((0:2)*365,rep(23,3))  
points(d16_x,YoungJackPine_16day,col="Blue",pch=20,cex=0.7)
lines(d16_x,YoungJackPine_16day,col="Blue",lwd=0.7)

legend("bottomleft",c("Daily avg","16-day avg"),pch=c(20,20),col=c(2,"blue"),cex=0.6)
@
...
<< echo=FALSE, fig.width=12, fig.height=4,fig.height=4,fig.cap='Saskatchewan old aspen NDVI data from 2003 to 2008.',fig.align='center',eval=FALSE>>=
plot(OldAspen_NDVI,ylim = c(0,1), pch=19, col=1,cex=0.8,axes = FALSE,xlab="Time",ylab="NDVI")
lines(OldAspen_NDVI,col="grey")

abline(v=cumsum(c(23,23,23,23,23)),lty="dashed")

t_x <- rep(11,6) + rep((0:5)*23)
text(t_x,1,labels = c("2003","2004","2005","2006","2007","2008"),cex=0.7)

lab <- c("Jan","June")
axis(side=1, at=rep(c(1,11),6)+rep((0:5)*23,rep(2,6)), labels= rep(lab,6), las=1)
axis(side=2, at=seq(0,1,by=0.2), lab=seq(0,1,by=0.2), las=2)
title(main="Old Aspen 2003 - 2008 \n Lat:53.63   Long:-106.20")
@
...
<< echo=FALSE, fig.width=12, fig.height=4, fig.cap='Saskatchewan old jack pine NDVI data from 2003 to 2008.',fig.align='center',eval=FALSE>>=
plot(OldJackPine_NDVI,ylim = c(0,1), pch=19, col=1,cex=0.8,axes = FALSE,xlab="Time",ylab="NDVI")
lines(OldJackPine_NDVI,col="grey")
...
axis(side=1, at=rep(c(1,11),6)+rep((0:5)*23,rep(2,6)), labels= rep(lab,6), las=1)
axis(side=2, at=seq(0,1,by=0.2), lab=seq(0,1,by=0.2), las=2)
title(main="Old Jack Pine 2003 - 2008 \n Lat:53.92   Long:-104.69")
@
...
<< echo=FALSE, fig.width=12, fig.height=4, fig.cap='Saskatchewan southern old black spruce NDVI data from 2003 to 2008.',fig.align='center',eval=FALSE>>=
plot(Southern_NDVI,ylim = c(0,1), pch=19, col=1,cex=0.8,axes = FALSE,xlab="Time",ylab="NDVI")
lines(Southern_NDVI,col="grey")
...
axis(side=1, at=rep(c(1,11),6)+rep((0:5)*23,rep(2,6)), labels= rep(lab,6), las=1)
axis(side=2, at=seq(0,1,by=0.2), lab=seq(0,1,by=0.2), las=2)
title(main="Southern Old Black Spruce 2003 - 2008 \n Lat:53.99   Long:-105.12")
@
...
<< echo=FALSE,fig.width=12,fig.height=4,fig.cap='Saskatchewan young jack pine NDVI data from 2004 to 2006.',fig.align='center',eval=FALSE>>=
plot(YoungJackPine_NDVI,ylim = c(0,1), pch=19, col=1,cex=0.8,axes = FALSE,xlab="Time",ylab="NDVI")
lines(YoungJackPine_NDVI,col="grey")

abline(v=cumsum(c(23,23)),lty="dashed")

t_x <- rep(11,3) + rep((0:2)*23)
text(t_x,1,labels = c("2004","2005","2006"),cex=0.7)

lab <- c("Jan","June")
axis(side=1, at=rep(c(1,11),3)+rep((0:2)*23,rep(2,3)), labels= rep(lab,3), las=1)
axis(side=2, at=seq(0,1,by=0.2), lab=seq(0,1,by=0.2), las=2)
title(main="(Young) Jack Pine 2004 - 2006 \n Lat:53.88   Long:-104.65")
@
...
\section{Eddy covariance method to calculate vertical flux.}
...
<<fig=T>>=
par(mfrow=c(3,2));plot(Mix,residuals=T,pch=20,cex=0.6)
@

<<fig=T>>=
layout(matrix(c(4,1,1,5,2,2,3,3),nrow=2,byrow=T))
qqnorm(residuals(Mix))
qqline(residuals(Mix),col=2)
acf(residuals(Mix))
pacf(residuals(Mix))
@
